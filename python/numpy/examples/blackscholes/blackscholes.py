...
def blackscholes(price, strike, t, rate, vol, intermediate_eval, use_group):
    ...
    # tmp testing: something with commutativity
    # put = e_rt * strike * (d2 - c10) - price * (d1 - c10)
...
if __name__ == '__main__':
    ...
    if args.use_numpy and args.use_weld:
        ...
        print("norm of put: ", np.linalg.norm(put2.view(np.ndarray)))
        print("norm between puts: ", np.linalg.norm(put - put2.view(np.ndarray)))
